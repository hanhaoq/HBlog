...
import top.hhq.exception.NotFoundException;
...
public class BlogServiceImpl implements BlogService {
	...
	private void setBlogViewsFromRedisToPageResult(PageResult<BlogInfo> pageResult) {
		...
		for (int i = 0; i < blogInfos.size(); i++) {
			 ...
			 * 3.重新启动程序
			 *
			 * 具体请查看: https://github.com/hhq/NBlog/issues/58
			 */
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void saveBlog(top.hhq.model.dto.Blog blog) {
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void updateBlog(top.hhq.model.dto.Blog blog) {
