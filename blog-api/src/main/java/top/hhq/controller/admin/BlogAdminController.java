...
import top.hhq.annotation.OperationLogger;
import top.hhq.entity.Blog;
import top.hhq.entity.Category;
import top.hhq.entity.Tag;
...
import top.hhq.service.CategoryService;
import top.hhq.service.CommentService;
import top.hhq.service.TagService;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.hhq.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.hhq.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.hhq.model.dto.Blog blog, String type) {
		//验证普通字段
