package top.hhq.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import top.hhq.config.properties.BlogProperties;
import top.hhq.constant.PageConstants;
...
import top.hhq.util.HashUtils;
import top.hhq.util.IpAddressUtils;
import top.hhq.util.MailUtils;
import top.hhq.util.QQInfoUtils;
import top.hhq.util.StringUtils;
import top.hhq.util.comment.channel.ChannelFactory;
import top.hhq.util.comment.channel.CommentNotifyChannel;
import top.hhq.enums.CommentOpenStateEnum;
import top.hhq.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.hhq.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.hhq.entity.Comment parentComment, Comment comment) {
