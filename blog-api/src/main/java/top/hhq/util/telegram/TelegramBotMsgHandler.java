...
import top.hhq.config.properties.TelegramProperties;
import top.hhq.entity.Comment;
import top.hhq.entity.Moment;
import top.hhq.enums.CommentPageEnum;
import top.hhq.service.CommentService;
import top.hhq.service.MomentService;
import top.hhq.util.comment.CommentUtils;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.hhq.model.dto.Comment comment = new top.hhq.model.dto.Comment();
