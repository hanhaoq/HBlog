package top.hhq.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.hhq.entity.ScheduleJobLog;
import top.hhq.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.hhq.entity.ScheduleJob scheduleJob = (top.hhq.entity.ScheduleJob) context.getMergedJobDataMap().get(top.hhq.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
